...
@dataclass
class CFG:
    exp_name: str = "exp059_1_stackedUnet"
    mode = ["train", "test"]
    debug: bool = False
    ...
    fragment_z: tuple[int, int] = (16, 48)
    ...
    train_compose = [
        ...
        A.Normalize(mean=[0] * (fragment_z[1]-fragment_z[0]), std=[1] * (fragment_z[1]-fragment_z[0])),
