...
@dataclass
class CFG:
    exp_name: str = "exp059_3_stackedUnet"
    descripton: str = f"""FILE: {__file__}
    stackedUnet, swa, add median blur to remove noise using median
    """
    mode = ["train", "test"]
    debug: bool = False
    ...
    # swa_start: int = 10
    swa_epoch_range: tuple[int, int] = (10, 20)
    swa_lr: float = 1e-7
    ...
    train_compose = [
        ...
        # A.MedianBlur(p=0.25, blur_limit=4),
        # 歪み系
