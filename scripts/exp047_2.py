...
- freeze encoder training after few epochs
...
class CFG:
    # ================= Global cfg =====================
    # parameterを今のできるだけ44に揃えた、差分はfreeze encoderのみのはず
    exp_name = "exp047_2_fold5_Unet++_effb4_advprop_gradualwarm_mixup_tile224_slide74"
    random_state = 42
    tile_size: int = 224
...
def train(cfg: CFG) -> None:
    for fold in range(1, cfg.n_fold + 1):
        ...
        for epoch in range(cfg.epoch):
            ...
            if epoch > cfg.freeze_encoder_epoch:
                freeze_encoder(net.model)
